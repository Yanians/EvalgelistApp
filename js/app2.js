 ...
 <div class="container">  
    <div class="row">
            ...
            &nbsp;
              ...
              <li class="sideNav-bg">
                <div class="collapsible-header"><i class="material-icons shadow-green">subject</i>Components</div>
                  <div class="collapsible-body">
                    <span>
                        <a href="#Badges" onclick="component.badges()">Badges</a>
                        <a href="#Buttons" onclick="component.buttons()">Buttons</a>
              ...
              <li class="sideNav-bg">
                <div class="collapsible-header"><i class="material-icons shadow-green">whatshot</i>JavaScript</div>
                <div class="collapsible-body">
                   <span>
    ...
    <div class="col s12 m9 l10">
      ...
      <div id="introduction" class="scrollspy section">
        ...
        <div class="carousel">
          ...
          <a class="carousel-item" href="#three!"><img src="images/b3.JPG"></a>
